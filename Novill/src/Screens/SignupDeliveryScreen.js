...
const SignupDeliveryScreen=({navigation})=>{
    const {state,signupDelivery,clearErrorMessage}=useContext(AuthContext);
    ...
    <ImageBackground source={require("../Screens/images/imag.jpg")} style={{ width:'100%', height:'100%' }}>        
      ...
      /*  backgroundColor:'rgb(220,220,220)',
            ...
            />
            <TextInput
                placeholder=' Pharm you want to work at name' 
                value={pname}
...
SignupDeliveryScreen.navigationOptions = () => {
    return {
      headerShown: false,
    };
  };
